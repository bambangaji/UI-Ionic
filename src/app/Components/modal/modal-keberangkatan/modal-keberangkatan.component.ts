...
@Component({
  selector: 'app-modal-keberangkatan',
  templateUrl: './modal-keberangkatan.component.html',
  styleUrls: ['./modal-keberangkatan.component.scss'],
})
export class ModalKeberangkatanComponent  implements OnInit {
